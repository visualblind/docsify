...
If you insist on using WiFi, then you are going to need to ensure that you are connected to a SSID that uses 802.11ac (or the newer 802.11ax aka WiFi6) and is using a channel width of at least 80 MHz.
...
Download the latest release on the [Roku Channel Store](https://channelstore.roku.com/details/4d9e526a7d972d4decf98ea6a84000f7:c617f4902629cc0bd1e1411db1775cf3/jellyfin).

Status: :fa-solid fa-star: Active

Links:

* [Roku Channel Store](https://channelstore.roku.com/details/4d9e526a7d972d4decf98ea6a84000f7:c617f4902629cc0bd1e1411db1775cf3/jellyfin)
...
:fa-solid fa-download: Click on the ellipsis  :fa-solid fa-ellipsis-vertical:  of the media you want to download and then click DOWNLOAD :fa-regular fa-floppy-disk:.
...
> The cumulative 30-day HTTPS uptime for the travisflix.com web service has on average been 99.95% - 99.99%
